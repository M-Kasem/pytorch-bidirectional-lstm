...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(
        datasets.MNIST('/home/nile002u1/data/pytorch-bidirectional-lstm/data', train=True, download=True,
    ...
    test_loader = torch.utils.data.DataLoader(
        datasets.MNIST('/home/nile002u1/data/pytorch-bidirectional-lstm/data', train=False, transform=transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize((0.1307,), (0.3081,))
                       ])),
    ...
    # train_loader.dataset.train_data = train_loader.dataset.train_data[:64, :, :]
    # train_loader.dataset.train_labels = train_loader.dataset.train_labels[:64]
