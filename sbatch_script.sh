...
python main.py --batch-size ${BATCH_SIZE} --log-interval 1 --lr 0.0001 --momentum 0.9 --epochs 2000 --seed 123 --exp_index 1 --job_id ${SLURM_JOB_ID} > "${SLURM_JOB_ID}_1.out" 2>&1 &
